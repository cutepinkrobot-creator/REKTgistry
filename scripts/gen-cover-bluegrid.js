...
// Blue grid — visible
ctx.strokeStyle = 'rgba(74,126,255,0.18)';
ctx.lineWidth = 1;
...
// Right accent glow — use the blue
const grd2 = ctx.createRadialGradient(W-200, H/2, 0, W-200, H/2, 340);
grd2.addColorStop(0, 'rgba(74,126,255,0.07)'); grd2.addColorStop(1, 'rgba(0,0,0,0)');
...
// gistry — white/slate
ctx.shadowBlur = 0;
ctx.fillStyle = '#d0d8e8'; ctx.font = 'bold 72px Orbitron';
...
const out = path.join(__dirname, '../public/rektgistry-twitter-cover-bluegrid2.png');
